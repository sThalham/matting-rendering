...
#ifdef (cl_x) #declare CamLoc=<cl_x,cl_y,cl_z>; #else #declare CamLoc=<0,0,-1.0>; #end // Camera Location
...
#macro OrientZ(p1,p2,cs)
    ...
    #declare pigmentStructure = pigment {
        ...
        #else
            image_map { png concat("./custom_data/graycode_512_512/graycode_", str(clock-2,1,0), ".png") map_type 0 interpolate 2 }
        #end
    }
#else
    #declare pigmentImage = pigment {
            ...
            color White
        #else
            #ifdef (rho) color White #else image_map { jpeg "./custom_data/graycode_512_512/graycode_" map_type 0 interpolate 2 } #end
        #end
    }
#end
